...
import { getAllReclamations } from '../fn/reclamation/get-all-reclamations';
import { GetAllReclamations$Params } from '../fn/reclamation/get-all-reclamations';
...
export class ReclamationService extends BaseService {
  ...
  /** Path part for operation `getAllReclamations()` */
  static readonly GetAllReclamationsPath = '/reclamation';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getAllReclamations()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAllReclamations$Response(params?: GetAllReclamations$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<Reclamation>>> {
    return getAllReclamations(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getAllReclamations$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getAllReclamations(params?: GetAllReclamations$Params, context?: HttpContext): Observable<Array<Reclamation>> {
    return this.getAllReclamations$Response(params, context).pipe(
