...
export class EnchereService extends BaseService {
   ...
   */
  getEnchById$Response(params: GetEnchById$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
   ...
   * This method doesn't expect any request body.
   */
  getEnchById(params: GetEnchById$Params, context?: HttpContext): Observable<void> {
